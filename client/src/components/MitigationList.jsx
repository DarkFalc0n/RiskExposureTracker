...
const MitigationList = () => {
  // ... No changes needed in this main component ...
...
// =======================================================
// === THIS IS THE UPDATED `MitigationRow` COMPONENT ===
// =======================================================
const MitigationRow = ({ item }) => {
  // NEW: State to manage the expanded/collapsed view for each row
  const [expanded, setExpanded] = useState(false);
  const maxChars = 100; // Set character limit for truncation

  // NEW: Logic to determine if text should be truncated
  const displayText =
  ...
  return (
    <tr>
      ...
      <td>
        {displayText}
        {/* NEW: Conditionally render the "See more" button */}
